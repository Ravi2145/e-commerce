import './ProductCard.css';
  ...
  function ProductCard(values) {
    // const ratingStar = Math.floor(Number(values.rating.rate));
    ...
    <div className="card-body">
      <p className='cart-text'>{values.item.category}</p>
      ...
      <a href="#" className="btn btn-success flex-box"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bag-plus" viewBox="0 0 16 16">
